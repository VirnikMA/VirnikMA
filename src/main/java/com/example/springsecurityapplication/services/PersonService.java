...
public class PersonService {
    ...
    // ДОПОЛНЕНИЯ БАЗОВОГО ПРОЕКТА

//    public void changePassword(int id, String password){
//        personRepository.updatePersonById(id, passwordEncoder.encode(password));	        personRepository.updatePersonById(id, passwordEncoder.encode(password));
//    }
