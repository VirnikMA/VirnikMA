...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/auth/start", "/error", "/auth/registration", "/product", "/product/info" +
                        "/{id}", "/img/**", "/css/**", "/product/search").permitAll()
...
//                .anyRequest().authenticated()
                ...
                .and()
                .formLogin().loginPage("/auth/start")
                ...
                .logout().logoutUrl("/logout").logoutSuccessUrl("/auth/start");
    }
